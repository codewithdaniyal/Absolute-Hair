...
className = "fixed top-14 left-0 right-0 z-40 bg-[#0D0D0D] border-b border-white/10 md:hidden overflow-hidden"
  >
  <div className="px-4 py-6 space-y-4" >
    <button
                onClick={ () => scrollToSection('services') }
className = "block w-full text-left text-white/70 hover:text-white font-['DM_Sans'] text-lg"
  >
  Services
  </button>
  < button
...
className = "block w-full text-center px-6 py-3 bg-white text-black font-['Raleway'] font-semibold rounded-[4px]"
  >
  Book Now
    </Link>
    </div>
